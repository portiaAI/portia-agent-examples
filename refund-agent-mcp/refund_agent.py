...
def main(customer_email: str):
    ...
    plan = portia.plan(
        """
Read the refund request email from the customer (in "inbox.txt") and decide if it should be approved
or rejected based on the refund policy in "refund_policy.txt".
